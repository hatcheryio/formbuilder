...
<div<?php if ($class) : ?> class="<?= $class ?>" <?php endif; ?>>
    <?php if ($label) : ?>
        <p class="radiogroup-label"><?= $label ?></p>
    <?php endif; ?>
    ...
    ?>
        <label <?php if ($class) : ?> class="<?= $class ?>" <?php endif; ?>>
            <input type="radio" name="<?= $name ?>" value="<?= $value ?>" <?php if ($req) : ?> required<?php endif; ?><?php if ($selected) : ?> checked<?php $selected = false;
                                                                                                                                                    endif; ?>>
            <?= $label ?>
        </label>
    <?php endforeach; ?>

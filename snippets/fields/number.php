...
<div<?php if($class): ?> class="<?= $class ?>"<?php endif; ?>>
    ...
    <input type="number" name="<?= $name ?>" id="<?= $name ?>"<?php if($class): ?> class="<?= $class ?>"<?php endif; ?> value="<?= $value ?>"<?php if($placeholder): ?> placeholder="<?= $placeholder ?>"<?php endif; ?><?php if($min):?> min="<?= $min ?>"<?php endif; ?><?php if($max):?> max="<?= $max ?>"<?php endif; ?><?php if($step):?> step="<?= $step ?>"<?php endif; ?><?php if($req):?> required<?php endif; ?>>
</div>
